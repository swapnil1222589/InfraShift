    ...
    <div className="bg-slate-900 border border-slate-800 rounded-xl p-5 md:p-6 shadow-sm">
      <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4">
        <div>
          ...
          {/* Title */}
          <h1 className="text-xl md:text-2xl font-bold text-slate-100 font-sans tracking-tight">
            {analysis.prTitle}
          </h1>
        ...
        <div className="flex items-center gap-2.5 self-start lg:self-center">
          ...
          <a
            href={`https://github.com/${analysis.repository}/pull/${analysis.prNumber}`}
            target="_blank"
            rel="noreferrer"
            className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-slate-800 hover:bg-slate-700 border border-slate-700 text-slate-200 text-xs font-medium rounded-md transition"
          >
